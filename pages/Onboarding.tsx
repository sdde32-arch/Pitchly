...
export const Onboarding: React.FC = () => {
  ...
  return (
    <div
      className="fixed inset-0 h-full w-full flex flex-col bg-app-base text-text-primary selection:bg-primary-lime/30 overflow-y-auto overflow-x-hidden scroll-smooth"
