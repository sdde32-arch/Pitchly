const fs = require('fs');
const content = fs.readFileSync('components/home/FootballPitchCard.tsx', 'utf8');
...
fs.writeFileSync('components/home/FootballPitchCard.tsx', newContent);
console.log('Pitch card updated');
